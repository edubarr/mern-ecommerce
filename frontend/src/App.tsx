        ...
        >
            ...
            <Navbar.Collapse>
              <Nav className="w-100 justify-content-end">
                ...
                {userInfo ? (
                  ...
                  <NavDropdown className="header-link" title={`Olá, Entrar`}>
          ...
          <div className="sub-header">
            <div className="d-flex">
              ...
              >
                <i className="fas fa-bars"></i> Tudo
              </Link>
              {["Ofertas", "Presentes", "Promoções"].map((x) => (
                <Link
                  key={x}
        ...
        <ListGroup variant="flush">
          <ListGroup.Item action className="side-navbar-user">
            <LinkContainer
              ...
              onClick={() => setSidebarIsOpen(!sidebarIsOpen)}
            >
              <span>{userInfo ? `Olá, ${userInfo.name}` : `Olá, Entrar`}</span>
            </LinkContainer>
          </ListGroup.Item>
          <ListGroup.Item>
            <div className="d-flex justify-content-between align-items-center">
